<?php 
function bluishost_fa_icons( $html = '' ){
  $icons = array(
	'fa-glass'=>'&#xf000;  fa-glass',
	'fa-music'=>'&#xf001;  fa-music',
	'fa-search'=>'&#xf002;  fa-search',
...
// the opt_name is set to bluishost_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/bluishost_opt/enqueue', 'bluishost_faIconFont' );
function bluishost_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome-min', BLUISHOST_DIR_CSS_URI.'font-awesome.min.css', array(), '1.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'bluishost-redux-admin', BLUISHOST_DIR_URI.'inc/redux-custom-field/assist/bluishost-redux-admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'bluishost-redux-admin', BLUISHOST_DIR_URI.'inc/redux-custom-field/assist/bluishost-redux-admin.js', array( 'jquery' ), '1.0', true );
