...
// image default alt
if( !function_exists( 'bluishost_img_default_alt' ) ){
	function bluishost_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'bluishost_img_tag' ) ){
	function bluishost_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = bluishost_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'bluishost_anchor_tag' ) ){
	function bluishost_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'bluishost_heading_tag' ) ){
	function bluishost_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'bluishost_paragraph_tag' ) ){
	function bluishost_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'bluishost_span_tag' ) ){
	function bluishost_span_tag( array $args ){
...
// Button Element 
if( !function_exists( 'bluishost_button_element ' ) ){
	function bluishost_button_element( array $args ){
